...
<html lang="pt-br">
  <head>
    ...
    <%@page import = "control.Modulo, control.Aula, control.Curso, java.util.List, control.Carrinho, control.Aluno" %>
        ...
        <div class="main-section">
            ...
            <div class="description row">
                <div class="desc-box col-md-6">
                    ...
                    <hr>
                    <a href="" class="btn btn-outline-primary">Faça o Download Aqui!</a>
                </div>
